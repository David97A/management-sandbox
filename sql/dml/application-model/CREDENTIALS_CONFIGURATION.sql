...
-- 1. Create pgcrypto extension to encrypt the passwords.

CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- 2. Insert the values of your credentiasl in the User's Table.
...
-- 3. Update the password value, using the function pgp_sym_encrypt, to encrypt the password value.
