...
GRANT SELECT ON TABLE "Operations"."Cards_Fact_CreditCardsTransactions" TO user_name;
GRANT SELECT ON TABLE "SalesService"."CustomerManagement_Dim_CustomersCatalog" TO user_name;
GRANT SELECT ON TABLE "BusinessSupport"."HumanResources_Dim_EmployeesCatalog" TO user_name;